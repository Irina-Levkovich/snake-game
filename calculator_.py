...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.proc.move(115,320)

        self.dabl_del = QPushButton('//', self)
        self.dabl_del.resize(50, 50)
        self.dabl_del.move(170, 320)

        self.sqrt_2 = QPushButton('^2', self)
        self.sqrt_2.resize(50, 50)
        self.sqrt_2.move(170, 45)
        ...
        self.dabl_del.clicked.connect(self.dabl_del_1)
        self.sqrt_2.clicked.connect(self.sqrt_2_1)
    ...
    def ravno(self):
        ...
        if self.operation == '//':
            self.rezult = (round(self.operand_1 / self.operand_2))
